...
function formatEmail($data) {
    ...
    $htmlEmail = "<h2>FUZEconnect Application</h2>";
    ...
    if ('Internet and Phone' == $data['Services Required'] || 'Internet Only' == $data['Services Required']) {
        $htmlEmail .= "<strong>Desired Username: </strong>" . $data['Username'] . "@fuzeconnect.net.au <br/>";
    ...
    $htmlEmail .= "<p>" . $data['First Name'] . " has read and understood the terms and conditions set out by FUZEconnect</p><br/><br/>";
...
function sendServiceEmail($filterdData) {
    ...
    $emailSubject = "FUZEconnect Application from " . $fullName;
    ...
    if(IS_TESTING)
        ...
        $fuzeApp->AddBCC("rowanm@selements.com.au", "FUZEconnect Manager" );
        $fuzeApp->AddBCC("bobadmin@e-wire.net.au", "FUZEconnect Admin");
    }
...
function emailCustomerConfirmation($filterdData) {
    ...
    $fullName = $filterdData['First Name'] . " " . $filterdData['Last Name'];
    $customerEmailSubject = "Welcome to FUZEconnect " . $filterdData['First Name'];
    ...
    $customerEmail->SetFrom("service@fuzeconnect.com.au", "FUZEconnect Service Team");
            ...
            <tr><td>
                    <p id="customerEmailFooter"> Kind Regards, <br/> <br/>
                        <img src="https://www.fuzeconnect.com.au/wp-content/uploads/2013/11/fuze_logo_small.gif"
                             alt="FUZEconnect"/><br/><br/>Customer Service Team</p><br/><br/>
                    <p id="smallPrint">If you receive this email by mistake, 
                        please notify us and do not make any use of the email.  
                        FUZEconnect does not waive any privilege, confidentiality or copyright associated with this email.</p>
            </td></tr>
        </table>
        </div>
    </body>
